for recommender system we should make two neural networks to predict content item data and content user data and these arrays should be in the same shape.
